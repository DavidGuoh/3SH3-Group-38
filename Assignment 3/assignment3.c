...
int sum = 0;
    ...
    if (strcmp(argv[2],"LEFT")==0){ //left scanning
        ...
        printf("\n");
        printf("C-SCAN DISK - Total head movements = %d\n",abs(atoi(argv[1])-0)+abs(299-array4[index+2])+abs(0-299));
    }
        ...
        printf("\n");
        printf("C-SCAN DISK - Total head movements = %d\n",abs(atoi(argv[1])-299)+abs(0-array4[index-1])+abs(0-299));
    }
    else{
        printf("Error, Direction should be LEFT or RIGHT");
    }
    ...
    if (strcmp(argv[2],"LEFT")==0){ //left scanning
        ...
        printf("\n");
        printf("LOOK DISK - Total head movements = %d\n",abs(atoi(argv[1])-res3[0])+abs(res3[0]-res3[INT_COUNT]));
        ...
        printf("\n");
        printf("LOOK DISK - Total head movements = %d\n",abs(atoi(argv[1])-res3[INT_COUNT])+abs(res3[INT_COUNT]-res3[0]));
    ...
    if (strcmp(argv[2],"LEFT")==0){ //left scanning
        ...
        printf("\n");
        printf("C-LOOK DISK - Total head movements = %d\n",abs(res5[INT_COUNT]-res5[0])+abs(res5[INT_COUNT]-atoi(argv[1])));
        ...
        printf("\n");
        printf("C-LOOK DISK - Total head movements = %d\n",abs(atoi(argv[1])-res5[INT_COUNT])+abs(res5[INT_COUNT]-res5[0])+abs(res5[0]-res5[index-1]));
